-------------------------------------------------
Developing for Jaspersoft Studio in Eclipse 4.4.x
-------------------------------------------------
...
1) 	Download an Eclipse Luna (4.4.x) 
2)	Install SVN plugin Subclipse version 1.10.x (http://subclipse.tigris.org/): choose by yourself to use SVNKit (Pure Java) or JavaHL (JNI).
3) 	Use the eclipse44x.p2f file to have all the required features installed.
