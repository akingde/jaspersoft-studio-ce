...
public class MCell extends MColumn implements IGraphicElement, IPastableGraphic, ILineBox {
	 ...
	 *          the new index
	 */
	public MCell(ANode parent, StandardBaseColumn column, Cell cell, String name) {
		super(parent, column, name);
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc, Map<String, Object> defaultsMap) {
		...
		styleD.setCategory(Messages.MCell_properties_category);
		hD.setCategory(Messages.MCell_properties_category);
		lineBoxD.setCategory(Messages.MCell_properties_category);
	...
	public void setPropertyValue(Object id, Object value) {
		if (cell != null) {
			if (id.equals(JRDesignCellContents.PROPERTY_STYLE)) {
				...
				cross.getTableManager().setHeight(cell, (Integer) value, (StandardBaseColumn) getValue());
