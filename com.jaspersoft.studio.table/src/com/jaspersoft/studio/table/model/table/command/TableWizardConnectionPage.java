...
public class TableWizardConnectionPage extends WizardPage {
	...
	protected TableWizardConnectionPage() {
		super("tablepage"); //$NON-NLS-1$
		setTitle(Messages.TableWizardConnectionPage_0);
		setDescription(Messages.TableWizardConnectionPage_1);
	}
