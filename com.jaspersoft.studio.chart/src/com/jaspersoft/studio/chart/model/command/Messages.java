...
public class Messages extends NLS {
	...
	public static String ChartWizardPage_meter_chart;
	public static String ChartWizardPage_multiaxis_chart;
	public static String ChartWizardPage_name;
	public static String ChartWizardPage_pie_chart;
	public static String ChartWizardPage_pie3d_chart;
	public static String ChartWizardPage_scatter_chart;
	public static String ChartWizardPage_thermometer_chart;
	public static String ChartWizardPage_timeseries_chart;
	static {
