...
public class MCandlestickPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc, Map<String, Object> defaultsMap) {
		...
		ColorPropertyDescriptor catAxisLabelColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR, Messages.MCandlestickPlot_category_axis_label_color, NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor catAxisLabelExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_EXPRESSION, Messages.MCandlestickPlot_category_axis_label_expression);
		...
		ColorPropertyDescriptor catAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_COLOR, Messages.MCandlestickPlot_category_axis_tick_label_color,
				NullEnum.INHERITED);
		...
		FontPropertyDescriptor catAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_FONT, Messages.MCandlestickPlot_category_axis_tick_label_font);
		...
		ColorPropertyDescriptor catAxisLineColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR, Messages.MCandlestickPlot_category_axis_line_color, NullEnum.NULL);
		...
		ColorPropertyDescriptor valAxisLabelColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR, Messages.MCandlestickPlot_value_axis_label_color, NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor valAxisLabelExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION, Messages.MCandlestickPlot_category_value_axis_label_expression);
		...
		ColorPropertyDescriptor valAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR, Messages.MCandlestickPlot_value_axis_tick_label_color, NullEnum.NULL);
		...
		FontPropertyDescriptor valAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, Messages.MCandlestickPlot_value_axis_tick_label_font);
		...
		ColorPropertyDescriptor valAxisLineColorD = new ColorPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, Messages.MCandlestickPlot_value_axis_line_color, NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor rangeAxisMinExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_RANGE_AXIS_MINVALUE_EXPRESSION, Messages.MCandlestickPlot_range_axis_minvalue_expression);
		...
		JRExpressionPropertyDescriptor rangeAxisMaxExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_RANGE_AXIS_MAXVALUE_EXPRESSION, Messages.MCandlestickPlot_range_axis_maxvalue_expression);
		...
		JRExpressionPropertyDescriptor domainAxisMinExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION, Messages.MCandlestickPlot_domain_axis_minvalue_expression);
		...
		JRExpressionPropertyDescriptor domainAxisMaxExprD = new JRExpressionPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION, Messages.MCandlestickPlot_domain_axis_maxvalue_expression);
		...
		CheckBoxPropertyDescriptor catAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_VERTICAL_TICK_LABELS, Messages.MCandlestickPlot_category_axis_vertical_tick_labels,
				NullEnum.NOTNULL);
		...
		CheckBoxPropertyDescriptor valAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS, Messages.MCandlestickPlot_value_axis_vertical_tick_labels,
				NullEnum.NOTNULL);
		...
		NTextPropertyDescriptor catAxisTickLabelMaskD = new NTextPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_MASK, Messages.MCandlestickPlot_category_axis_tick_label_mask);
		...
		NTextPropertyDescriptor valAxisTickLabelMaskD = new NTextPropertyDescriptor(
				JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK, Messages.MCandlestickPlot_value_axis_tick_label_mask);
