...
public class MBarPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc, Map<String, Object> defaultsMap) {
		...
		ColorPropertyDescriptor catAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR, Messages.MBarPlot_category_axis_tick_label_color, NullEnum.NULL);
		...
		ColorPropertyDescriptor valAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR, Messages.MBarPlot_value_axis_tick_label_color, NullEnum.NULL);
		...
		PlotPropertyDescriptor itemLabelD = new PlotPropertyDescriptor(JRDesignBarPlot.PROPERTY_ITEM_LABEL, Messages.MBarPlot_item_label);
		...
		CheckBoxPropertyDescriptor catAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_VERTICAL_TICK_LABELS, Messages.MBarPlot_category_axis_vertical_tick_labels,
				NullEnum.NOTNULL);
		...
		CheckBoxPropertyDescriptor valAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS, Messages.MBarPlot_value_axis_vertical_tick_labels, NullEnum.NOTNULL);
