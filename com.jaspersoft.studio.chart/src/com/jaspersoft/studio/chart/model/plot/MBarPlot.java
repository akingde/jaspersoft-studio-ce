...
public class MBarPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc, Map<String, Object> defaultsMap) {
		...
		ColorPropertyDescriptor catAxisLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_COLOR, "Category Axis Label Color", NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor catAxisLabelExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_EXPRESSION, "Category Axis Label Expression");
		...
		FontPropertyDescriptor catAxisLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_FONT, "Category Axis Label Font");
		...
		ColorPropertyDescriptor catAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR, "Category Axis Tick Label Color", NullEnum.NULL);
		...
		FontPropertyDescriptor catAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_FONT, "Category Axis Tick Label Font");
		...
		ColorPropertyDescriptor catAxisLineColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LINE_COLOR, "Category Axis Line Color", NullEnum.NULL);
		...
		ColorPropertyDescriptor valAxisLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR, "Value Axis Label Color", NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor valAxisLabelExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION, "Category Value Axis Label Expression");
		...
		FontPropertyDescriptor valAxisLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_LABEL_FONT, "Value Axis Label Font");
		...
		ColorPropertyDescriptor valAxisTickLabelColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR, "Value Axis Tick Label Color", NullEnum.NULL);
		...
		FontPropertyDescriptor valAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT, "Value Axis Tick Label Font");
		valAxisTickLabelFontD.setDescription("Value Axis Tick Label Font.");
		desc.add(valAxisTickLabelFontD);

		PlotPropertyDescriptor itemLabelD = new PlotPropertyDescriptor(JRDesignBarPlot.PROPERTY_ITEM_LABEL, "Item Label");
		itemLabelD.setDescription("Item Label.");
		desc.add(itemLabelD);

		ColorPropertyDescriptor valAxisLineColorD = new ColorPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_LINE_COLOR, "Value Axis Line Color", NullEnum.NULL);
		...
		JRExpressionPropertyDescriptor rangeAxisMinExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_RANGE_AXIS_MINVALUE_EXPRESSION, "Range Axis Minvalue Expression");
		...
		JRExpressionPropertyDescriptor rangeAxisMaxExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_RANGE_AXIS_MAXVALUE_EXPRESSION, "Range Axis Maxvalue Expression");
		...
		JRExpressionPropertyDescriptor domainAxisMinExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION, "Domain Axis Minvalue Expression");
		...
		JRExpressionPropertyDescriptor domainAxisMaxExprD = new JRExpressionPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION, "Domain Axis Maxvalue Expression");
		...
		CheckBoxPropertyDescriptor catAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_VERTICAL_TICK_LABELS, "Category Axis Vertical Tick Labels",
				NullEnum.NOTNULL);
		...
		CheckBoxPropertyDescriptor valAxisVertTickLabelD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS, "Value Axis Vertical Tick Labels", NullEnum.NOTNULL);
		...
		CheckBoxPropertyDescriptor showTickLabelsD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_SHOW_TICK_LABELS, "Show Tick Labels", NullEnum.NOTNULL);
		showTickLabelsD.setDescription("Show tick Labels.");
		desc.add(showTickLabelsD);

		CheckBoxPropertyDescriptor showTickMarksD = new CheckBoxPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_SHOW_TICK_MARKS, "Show Tick Marks", NullEnum.NOTNULL);
		showTickMarksD.setDescription("Show tick marks.");
		desc.add(showTickMarksD);

		NTextPropertyDescriptor catAxisTickLabelMaskD = new NTextPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK, "Category Axis Tick Label Mask");
		...
		NTextPropertyDescriptor valAxisTickLabelMaskD = new NTextPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK, "Value Axis Tick Label Mask");
		...
		DoublePropertyDescriptor catAxisTickLabelRotation = new DoublePropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_ROTATION, "Category Axis Tick Label Rotation");
