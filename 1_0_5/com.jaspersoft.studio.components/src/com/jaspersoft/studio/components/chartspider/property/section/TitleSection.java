...
public class TitleSection extends AbstractSection {
	...
	public void createControls(Composite parent,
		...
		btnFont = new SPFont(parent, this, StandardChartSettings.PROPERTY_TITLE_FONT);
	...
	public void refresh() {
		...
		if (element != null) {
			foreButton.setData((RGB) element
					.getPropertyValue(StandardChartSettings.PROPERTY_TITLE_COLOR));

			btnEdgeEnum.setData((Integer) element
					.getPropertyValue(StandardChartSettings.PROPERTY_TITLE_POSITION));

			btnFont.setData(element, (MFont) element
					.getPropertyValue(StandardChartSettings.PROPERTY_TITLE_FONT));
