...
public class LegendSection extends AbstractSection {
	...
	public void createControls(Composite parent,
		...
		btnFont = new SPFont(parent, this, StandardChartSettings.PROPERTY_LEGEND_FONT);
	...
	public void refresh() {
		...
		if (element != null) {
			backButton
					.setData((RGB) element
							.getPropertyValue(StandardChartSettings.PROPERTY_LEGEND_BACKGROUND_COLOR));
			foreButton.setData((RGB) element
					.getPropertyValue(StandardChartSettings.PROPERTY_LEGEND_COLOR));

			btnEdgeEnum.setData((Integer) element
					.getPropertyValue(StandardChartSettings.PROPERTY_LEGEND_POSITION));

			showLegend.setData((Boolean) element
							.getPropertyValue(StandardChartSettings.PROPERTY_SHOW_LEGEND));

			btnFont.setData(element, (MFont) element
					.getPropertyValue(StandardChartSettings.PROPERTY_LEGEND_FONT));
		}
		isRefreshing = false;
	}
