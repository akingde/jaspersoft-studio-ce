 ...
 *
 */
public class UnitDragSourceListener extends DragSourceAdapter {
	  ...
	  /**
	   * Read the selected report unit and generate the data for the event, serializing 
	   * an array of string with some of the unit informations. The serializing is done 
	   * using the UnitTransfer class
	   */
