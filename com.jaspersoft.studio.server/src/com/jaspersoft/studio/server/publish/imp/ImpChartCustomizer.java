...
/**
 * Class used to search and propose for the upload also the jar of the customizers. It will search 
 * its jar and if it is found it propose to upload that jar
 * 
...
public class ImpChartCustomizer extends AImpObject {
	...
	/**
	 * Build the list of the customizers embedded in JR that doesn't need to be uploaded
	 */
	...
	public List<String> getSubCustmizersClass(JRChart chart){
		...
		List<JRPropertiesUtil.PropertySuffix> properties = JRPropertiesUtil.getProperties(chart.getPropertiesMap(), NamedChartCustomizer.CUSTOMIZER_CLASS_PROPERTY_PREFIX);
