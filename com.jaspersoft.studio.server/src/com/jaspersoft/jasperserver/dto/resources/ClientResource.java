 ...
 * 
 * @param <BuilderType>
 *          - concrete type of builder, usually it is concrete resource type
 *          like this: public class SomeConcreteClientResource extends
 *          ClientResource<SomeConcreteClientResource> This parameter is needed
 *          for convenient usage of client DTO as builders. Even superclass'
 *          setters returns correct type of resource.
 * 
...
public abstract class ClientResource<BuilderType extends ClientResource<BuilderType>> implements ClientUriHolder {
	...
	// unchecked cast to BuilderType safety assured by the rule of usage
	// BuilderType generic parameter.
