 ...
 * The Class MBarcode.
 */
public class MBarcode extends MGraphicElement {
	...
	public static IIconDescriptor getIconDescriptor() {
		if (iconDescriptor == null)
			iconDescriptor = new NodeIconDescriptor("barcode");
	 ...
	 *          the new index
	 */
	public MBarcode(ANode parent, JRDesignBarPlot jrBarcode, int newIndex) {
