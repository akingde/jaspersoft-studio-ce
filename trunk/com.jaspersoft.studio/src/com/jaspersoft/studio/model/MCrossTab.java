 ...
 * The Class MCrossTab.
 */
public class MCrossTab extends MGraphicElement {
	...
	public static IIconDescriptor getIconDescriptor() {
		if (iconDescriptor == null)
			iconDescriptor = new NodeIconDescriptor("crosstab");
	 ...
	 *          the new index
	 */
	public MCrossTab(ANode parent, JRDesignCrosstab jrCrosstab, int newIndex) {
	...
	public JRDesignElement createJRElement(JasperDesign jasperDesign) {
		JRDesignElement jrDesignElement = new JRDesignCrosstab();
