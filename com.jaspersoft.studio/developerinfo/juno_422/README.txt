-------------------------------------------------
Developing for Jaspersoft Studio in Eclipse 4.2.2
-------------------------------------------------
...
1) 	Download an Eclipse Juno SR2 (4.2.2) for RCP and RAP developers
...
3) 	Use the eclipse422.p2f file to have all the required features installed.
	...
	Select the "eclipse422.p2f" file and follow the steps.
