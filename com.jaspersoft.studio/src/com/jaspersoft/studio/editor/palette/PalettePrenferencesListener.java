...
/**
 * Listener used to refresh the visibility of the tool entry on the palette
 * when the property to show or hide an element is changed
 * 
...
public class PalettePrenferencesListener implements IPropertyChangeListener{
	...
	/**
	 * When the property of the visibility of the palette changes a tool entry with
	 * the id of the changed is searched and its visiblity updated
	 */
	@Override
