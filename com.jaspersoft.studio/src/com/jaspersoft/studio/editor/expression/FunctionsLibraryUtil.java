...
public class FunctionsLibraryUtil {
	...
	/**
	 * Checks if the functions library is changed. This could have happened
	 * because the user has changed the classpath adding a new jar that contains
	 * contributed functions.
	 * 
	 * @return <code>true</code> if library is changed, <code>false</code>
	 *         otherwise
	 */
	...
	public static void reloadLibraryIfNeeded(){
		if(functionsLibraryIsChanged()) reloadLibrary();
	}
	...
	/*
	 * Gets all the possible references to functions.
	 * The current active editor is used.
	 */
