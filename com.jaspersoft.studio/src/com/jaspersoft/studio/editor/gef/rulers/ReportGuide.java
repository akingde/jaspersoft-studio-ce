 ...
 * guide, ReportGuide also maintains information about the edge along which
 * those parts are attached. This information is useful during resize operations
 * to determine the attachment status of a part.
 * 
 * @author Chicu Veaceslav
 */
public class ReportGuide implements Serializable {
	 ...
	 */
	public ReportGuide(boolean isHorizontal) {
	 ...
	 */
	public void attachPart(INode part, int alignment) {
		// if (getMap().containsKey(part) && getAlignment(part) == alignment)
		// return;
		//
		// getMap().put(part, new Integer(alignment));
		// ReportGuide parent = isHorizontal() ? part.getHorizontalGuide() :
		// part.getVerticalGuide();
	 ...
	 */
	public void detachPart(INode part) {
	 ...
	 *         {@link org.eclipse.gef.examples.logicdesigner.edit.LogicXYLayoutEditPolicy LogicXYLayoutEditPolicy} to
	 *         determine whether to attach or detach a part from a guide during resize operations.
	 ...
	 *      EditPart, Object)
	 */
	public int getAlignment(INode part) {
