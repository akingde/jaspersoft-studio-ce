...
/**
 * Matching strategy for JRXML standard files.
 * 
 * @author Massimo Rabbi (mrabbi@users.sourceforge.net)
 *
 */
public class StandardJRXMLMatchStrategy implements IEditorMatchingStrategy {
	...
	public boolean matches(IEditorReference editorRef, IEditorInput input) {
		...
		if(file!=null && JrxmlContentDescriber.isStandardJRXML(file)){
			return true;
		}
		else {
			return false;
