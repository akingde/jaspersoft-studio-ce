...
public abstract class JSSWizardHandler extends AbstractHandler {
	 ...
	 * Subclasses can for example modify the behavior contributing of 
	 * the standard buttonbar contributing a new one.
	 * They can easily do this by using their one {@link WizardDialog} implementation. 
	 * 
	 * @param parent the parent shell
	 * @param wizard the wizard to be created in the dialog
	 */
