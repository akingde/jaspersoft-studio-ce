...
public class G2DExporterPreferencePage extends FieldEditorOverlayPage {
	...
	public void createFieldEditors() {
		addField(new BooleanFieldEditor(NSF_EXPORT_G2D_MINJOBSIZE, Messages.G2DExporterPreferencePage_3,
	...
	public static void getDefaults(IPreferenceStore store) {
		...
		store.setDefault(NSF_EXPORT_G2D_ZOOM_RATIO, Misc.nvl(PropertiesHelper.DPROP.getProperty(NSF_EXPORT_G2D_ZOOM_RATIO), "1")); //$NON-NLS-1$
	}
