...
public class InputParameterDialog extends Dialog {
	...
	/**
	 * The current jasperreports configuration
	 */
	 ...
	 */
	public InputParameterDialog(Shell parentShell, JRSubreportParameter editedParameter, JasperReportsConfiguration jconfig, List<JRSubreportParameter> previousParameters) {
		super(parentShell);
	 ...
	 * @param previousParameters the list of parameters already defined
	 */
	public InputParameterDialog(Shell parentShell, JasperReportsConfiguration jConfig, List<JRSubreportParameter> previousParameters) {
		this(parentShell, new JRDesignSubreportParameter(), jConfig, previousParameters);
		originalName = null;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		parameterExpression.setExpressionContext(new ExpressionContext(jConfig));
