...
class JRQueryDialog extends Dialog {
	/**
	 ...
	 */
	private JRDesignQuery value;//$NON-NLS-1$
	 ...
	 */
	public JRQueryDialog(Shell parentShell, String dialogTitle, String dialogMessage, JRDesignQuery initialValue,
