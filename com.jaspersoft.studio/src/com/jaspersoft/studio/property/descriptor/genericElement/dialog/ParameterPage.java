...
public class ParameterPage extends WizardPage implements IExpressionContextSetter {
	 ...
	 */
	private List<JRGenericElementParameter> value = new ArrayList<JRGenericElementParameter>();
	...
	public ParameterDTO getValue() {
		...
		result.setValue(value.toArray(new JRGenericElementParameter[value.size()]));
		return result;
	}
	
	public void setValue(ParameterDTO value) {
		if (value != null && value.getValue() != null){
			this.value = new ArrayList<JRGenericElementParameter>();
	...
	public void createControl(Composite parent) {
		...
		editButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (selection.size() > 0){
					JRDesignGenericElementParameter selectedValue = (JRDesignGenericElementParameter)selection.getFirstElement();
		...
		deleteButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				StructuredSelection selection = (StructuredSelection)tableViewer.getSelection();
				if (selection.size() > 0){
					JRGenericElementParameter selectedValue = (JRGenericElementParameter)selection.getFirstElement();
	 ...
	 */
	private void editElement(JRGenericElementParameter edited){
		JRDesignGenericElementParameter result = (JRDesignGenericElementParameter)edited.clone();
	...
	private void attachCellEditors(final TableViewer viewer) {
		viewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				...
				if (selectedIndex != -1){
					JRGenericElementParameter selectedElement = value.get(selectedIndex);
