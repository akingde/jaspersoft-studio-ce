...
public class ComboMenuViewer  implements IMenuProvider{
    ...
    /**
     * Represent the action associated to every element of the menu, so it represent an 
     * entry in the menu
     * @author Orlandin Marco
     *
     */
     ...
     * @return the value type depends on how the ComboItem that 
     * define this voice is defined
     */
     ...
     * @param newItems an array of element
     */
    ...
    /**
     * Set the elements inside the menu manager
     * @param newItems a list of element
     */
