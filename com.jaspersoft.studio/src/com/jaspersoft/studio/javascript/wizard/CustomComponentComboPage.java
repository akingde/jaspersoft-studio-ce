...
public class CustomComponentComboPage extends JSSWizardPage {
	...
	protected CustomComponentComboPage() {
	...
	public boolean isPageComplete() {
		if (combo.getSelectionIndex() == 0){
			setErrorMessage("You must select a valid library");
			return false;
		}
		...
		if (projectName.getText().contains(" ")) {
			setErrorMessage("No spaces allowed in the name");
			return false;
		}
