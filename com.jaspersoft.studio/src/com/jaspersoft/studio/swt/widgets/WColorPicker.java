...
/**
 * A custom widget that lets the user pick a color using the standard {@link ColorDialog} window.
 * The widgets is composed by three parts:
 * <ul>
 ...
 * </ul>
 * 
 * Users can retrieve the modified information through the different getters: {@link #getSelectedColorAsAWTColor()}, {@link #getSelectedColorAsRGB()} and {@link #getSelectedColorAsSWTColor()}.<br>
...
public class WColorPicker extends Composite{
	...
	public WColorPicker(RGB preselectedRGB, Composite parent, int style) {
		super(parent, style);
	...
	/**
	 * Sets the new color (as {@link RGB} value).
	 * It also notifies all listeners of the color change occurred.
	 * 
	 * @param newColor the new RGB color to set
	 */
	 ...
	 * <p>
	 * <b>NOTE</b>: the {@link Color} instance returned must be directly disposed
	 * by the user in order to release system resources. No automatic disposal is given.
	 * 
	 * @return the SWT selected color
	 */
	public Color getSelectedColorAsSWTColor(){
		return selectedRGB!=null ? new Color(null,selectedRGB) : null;
	}
