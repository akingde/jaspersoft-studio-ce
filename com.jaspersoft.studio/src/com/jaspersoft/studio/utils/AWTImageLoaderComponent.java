...
public class AWTImageLoaderComponent extends Component {
	...
	/**
	 * Uses the default {@link Toolkit} to load an image from the specified location.
	 * A {@link MediaTracker} instance is created to wait the loading of the AWT image.
	 * 
	 * @param imgLocation the image location
	 * @return the AWT image loaded
	 * @throws IOException if something goes wrong during image loading
	 */
