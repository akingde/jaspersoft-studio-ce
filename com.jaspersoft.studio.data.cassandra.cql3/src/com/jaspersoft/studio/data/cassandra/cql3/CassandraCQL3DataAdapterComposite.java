...
public class CassandraCQL3DataAdapterComposite extends ADataAdapterComposite {
	...
	public void setDataAdapter(DataAdapterDescriptor dataAdapterDescriptor) {
		...
		CassandraCQL3DataAdapter dataAdapter = (CassandraCQL3DataAdapter) dataAdapterDescriptor
				.getDataAdapter();
	...
	protected void bindWidgets(DataAdapter dataAdapter) {
		bindingContext.bindValue(
				...
				PojoObservables.observeValue(dataAdapter, "hostname"));
		bindingContext.bindValue(
		...
		bindingContext.bindValue(
				...
				PojoObservables.observeValue(dataAdapter, "keyspace"));
		bindingContext.bindValue(
				SWTObservables.observeText(cassandraVersion, SWT.Modify),
				PojoObservables.observeValue(dataAdapter, "cassandraVersion"));
		bindingContext.bindValue(
				SWTObservables.observeText(clustername, SWT.Modify),
				PojoObservables.observeValue(dataAdapter, "clustername"));
	}
