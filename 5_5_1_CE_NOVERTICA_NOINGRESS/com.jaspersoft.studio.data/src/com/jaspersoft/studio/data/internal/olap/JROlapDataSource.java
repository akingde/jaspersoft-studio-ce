...
import com.jaspersoft.studio.data.internal.mapping.AxisPosition;
import com.jaspersoft.studio.data.internal.mapping.DataMapping;
import com.jaspersoft.studio.data.internal.mapping.Mapping;
import com.jaspersoft.studio.data.internal.mapping.MappingLexer;
import com.jaspersoft.studio.data.internal.mapping.MappingMetadata;
import com.jaspersoft.studio.data.internal.mapping.MappingParser;
import com.jaspersoft.studio.data.internal.mapping.Member;
import com.jaspersoft.studio.data.internal.mapping.MemberDepth;
import com.jaspersoft.studio.data.internal.mapping.MemberMapping;
import com.jaspersoft.studio.data.internal.mapping.MemberProperty;
import com.jaspersoft.studio.data.internal.mapping.Tuple;
import com.jaspersoft.studio.data.internal.mapping.TuplePosition;
...
public class JROlapDataSource implements JRDataSource, MappingMetadata
{
	...
	private void init(JRDataset dataset)
	{
		...
		if (fields != null)
		{
			for (int i = 0; i < fields.length; i++)
			{
				...
				Mapping mapping;
				log.debug("Mapping field: " + field.getName() + " - description: " + field.getDescription());
				try
				{
	...
	protected void processMemberInfo(com.jaspersoft.studio.data.internal.mapping.Member member)
	{
	...
	public int getDimensionIndex(com.jaspersoft.studio.data.internal.mapping.Axis axis, String dimension)
	{
		...
		for (int i = 0; dimensionIndex == -1 && i < hierarchies.length; i++)
		{
			...
			if (hierarchy.matchDimensionName(dimension))
			{
				dimensionIndex = i;
			}
		}
	...
	protected void setMatchMemberDepth(com.jaspersoft.studio.data.internal.mapping.Member memberInfo, JROlapMember member)
	{
	...
	protected abstract class FieldMatcher
	{
		...
		public final JROlapMember member(com.jaspersoft.studio.data.internal.mapping.Member memberInfo, int[] positions)
		{
	...
	{
		final com.jaspersoft.studio.data.internal.mapping.Member memberInfo;
	...
	protected class DataFieldMatcher extends FieldMatcher
	{
		...
		private final com.jaspersoft.studio.data.internal.mapping.Member[] members;
