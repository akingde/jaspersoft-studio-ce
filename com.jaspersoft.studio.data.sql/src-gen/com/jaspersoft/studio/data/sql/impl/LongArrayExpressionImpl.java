 ...
 * <ul>
 *   <li>{@link com.jaspersoft.studio.data.sql.impl.LongArrayExpressionImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LongArrayExpressionImpl extends ArrayExpressionImpl implements LongArrayExpression
{
  ...
  {
    return SqlPackage.Literals.LONG_ARRAY_EXPRESSION;
  }
  ...
  public EList<Long> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<Long>(Long.class, this, SqlPackage.LONG_ARRAY_EXPRESSION__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SqlPackage.LONG_ARRAY_EXPRESSION__VALUES:
        return getValues();
    }
