 ...
 * <ul>
 *   <li>{@link com.jaspersoft.studio.data.sql.impl.BooleanExpressionImpl#getTrue <em>True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpressionImpl extends ExpressionImpl implements BooleanExpression
{
  ...
  {
    return SqlPackage.Literals.BOOLEAN_EXPRESSION;
  }
  ...
  public void setTrue(String newTrue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SqlPackage.BOOLEAN_EXPRESSION__TRUE, oldTrue, true_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SqlPackage.BOOLEAN_EXPRESSION__TRUE:
        return getTrue();
    }
