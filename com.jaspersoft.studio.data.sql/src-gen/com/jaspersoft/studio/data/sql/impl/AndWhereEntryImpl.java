 ...
 * <ul>
 *   <li>{@link com.jaspersoft.studio.data.sql.impl.AndWhereEntryImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndWhereEntryImpl extends WhereEntryImpl implements AndWhereEntry
{
  ...
  {
    return SqlPackage.Literals.AND_WHERE_ENTRY;
  }
  ...
  public EList<WhereEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<WhereEntry>(WhereEntry.class, this, SqlPackage.AND_WHERE_ENTRY__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SqlPackage.AND_WHERE_ENTRY__ENTRIES:
