...
public class InternalSqlLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../com.jaspersoft.studio.data.sql/src-gen/com/jaspersoft/studio/data/parser/antlr/lexer/InternalSqlLexer.g:183:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u3042' .. '\\u3093' | '\\u30A2' .. '\\u30F3' | '\\u30FC' | '0' .. '9' )* )
            // ../com.jaspersoft.studio.data.sql/src-gen/com/jaspersoft/studio/data/parser/antlr/lexer/InternalSqlLexer.g:183:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u3042' .. '\\u3093' | '\\u30A2' .. '\\u30F3' | '\\u30FC' | '0' .. '9' )*
            {
            // ../com.jaspersoft.studio.data.sql/src-gen/com/jaspersoft/studio/data/parser/antlr/lexer/InternalSqlLexer.g:183:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '\\u3042' .. '\\u3093' | '\\u30A2' .. '\\u30F3' | '\\u30FC' | '0' .. '9' )*
            loop14:
            do {
