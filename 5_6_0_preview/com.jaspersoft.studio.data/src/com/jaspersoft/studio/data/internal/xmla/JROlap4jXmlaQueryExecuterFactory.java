 ...
 */
public class JROlap4jXmlaQueryExecuterFactory extends JRXmlaQueryExecuterFactory
{
	...
	{
		return new JROlap4jXmlaQueryExecuter(jasperReportsContext, dataset, parameters);
	}
