...
public class CassandraConnection implements Connection {
	...
	private final Pattern urlPattern = Pattern.compile(
			"jdbc:cassandra://(.+):([0-9]+)/?.*", Pattern.CASE_INSENSITIVE);

	public CassandraConnection(String jdbcURL) throws ClassNotFoundException,
			JRException {
	...
	private void validateHostAndPort(String hostName, Integer port)
			throws JRException {
	 ...
	 */
	public static String getJdbcTypeClass(ResultSetMetaData resultSetMetaData,
			int index) {
