		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getQueryAssignment(), "rule__Model__QueryAssignment");
					...
					put(grammarAccess.getSelectAccess().getOrderByEntryAssignment_9_1(), "rule__Select__OrderByEntryAssignment_9_1");
					...
					put(grammarAccess.getSelectAccess().getFetchFirstAssignment_12_1(), "rule__Select__FetchFirstAssignment_12_1");
