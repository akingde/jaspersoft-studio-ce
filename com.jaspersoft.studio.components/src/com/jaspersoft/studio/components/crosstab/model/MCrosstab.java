...
public class MCrosstab extends MGraphicElementLineBox
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRBaseCrosstab.PROPERTY_RUN_DIRECTION)) {
			...
			// fire the event to update the editor name, because the property of
	...
	/**
	 * Check if in the current crosstab is set the flag to autoresize the
	 * columns taking the space from the next one when it is drag and dropped
	 * 
	 * @return true if the resize of a column should take the space from the
	 *         next one, false otherwise
	 */
	...
	/**
	 * Check if the passed event is a resize event of the column or of the
	 * crosstab
	 * 
	 * @param evt
	 *            a not null event
