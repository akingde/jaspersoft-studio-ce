	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(StandardSpiderPlot.PROPERTY_AXIS_LINE_COLOR)) {
			if (value instanceof RGB)
				cp.setAxisLineColor(Colors.getAWT4SWTRGBColor((RGB) value));
			...
			if (value instanceof RGB)
				cp.setLabelColor(Colors.getAWT4SWTRGBColor((RGB) value));
			...
			if (value instanceof RGB)
				cs.setTitleColor(Colors.getAWT4SWTRGBColor((RGB) value));
		} else if (id.equals(StandardChartSettings.PROPERTY_SUBTITLE_COLOR)) {
			if (value instanceof RGB)
				cs.setSubtitleColor(Colors.getAWT4SWTRGBColor((RGB) value));
		} else if (id.equals(StandardChartSettings.PROPERTY_LEGEND_COLOR)) {
			if (value instanceof RGB)
				cs.setLegendColor(Colors.getAWT4SWTRGBColor((RGB) value));
		} else if (id
