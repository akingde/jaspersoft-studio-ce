...
public class MarkersDescriptor extends ADescriptor {
	...
	protected void initItemPropertyDescriptors() {
		itemProperties = new ItemPropertyDescription[] {
				...
				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_url, Messages.MarkersDescriptor_5,
				...
				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_icon,
						Messages.MarkersDescriptor_14, Messages.MarkersDescriptor_15, false),
				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_ICON_url,
						Messages.MarkersDescriptor_16, Messages.MarkersDescriptor_17, false),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_width,
						Messages.MarkersDescriptor_18, Messages.MarkersDescriptor_19, false, new Integer(0), null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_height,
						Messages.MarkersDescriptor_20, Messages.MarkersDescriptor_21, false, new Integer(0), null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_ORIGIN_x,
						Messages.MarkersDescriptor_22, Messages.MarkersDescriptor_23, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_ORIGIN_y,
						Messages.MarkersDescriptor_24, Messages.MarkersDescriptor_25, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_ANCHOR_x,
						Messages.MarkersDescriptor_26, Messages.MarkersDescriptor_27, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_ICON_ANCHOR_y,
						Messages.MarkersDescriptor_28, Messages.MarkersDescriptor_29, false, new Integer(0), null,
						null),

				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_shadow,
						Messages.MarkersDescriptor_30, Messages.MarkersDescriptor_31, false),
				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_url,
						Messages.MarkersDescriptor_32, Messages.MarkersDescriptor_33, false),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_width,
						Messages.MarkersDescriptor_34, Messages.MarkersDescriptor_35, false, new Integer(0), null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_height,
						Messages.MarkersDescriptor_36, Messages.MarkersDescriptor_37, false, new Integer(0), null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_ORIGIN_x,
						Messages.MarkersDescriptor_38, Messages.MarkersDescriptor_39, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_ORIGIN_y,
						Messages.MarkersDescriptor_40, Messages.MarkersDescriptor_41, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_ANCHOR_x,
						Messages.MarkersDescriptor_42, Messages.MarkersDescriptor_43, false, new Integer(0), null,
						null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_SHADOW_ANCHOR_y,
						Messages.MarkersDescriptor_44, Messages.MarkersDescriptor_45, false, new Integer(0), null,
						null),

				new ItemPropertyDescription<String>(MapComponent.ITEM_PROPERTY_MARKER_INFOWINDOW_content,
						Messages.MarkersDescriptor_46, Messages.MarkersDescriptor_47, false),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_INFOWINDOW_pixelOffset,
						Messages.MarkersDescriptor_48, Messages.MarkersDescriptor_49, false, null, null),
				new NumberPropertyDescription<Integer>(MapComponent.ITEM_PROPERTY_MARKER_INFOWINDOW_maxWidth,
