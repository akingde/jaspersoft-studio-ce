...
public class MCandlestickPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc,
		...
		catAxisLabelColorD
				.setDescription(Messages.MCandlestickPlot_category_axis_label_color_description);
		...
		ColorPropertyDescriptor catAxisTickLabelColorD = new ColorPropertyDescriptor(
				...
				Messages.common_category_axis_tick_label_color,
				NullEnum.INHERITED);
		catAxisTickLabelColorD
				.setDescription(Messages.MCandlestickPlot_category_axis_tick_label_color_description);
		...
		catAxisLineColorD
				.setDescription(Messages.MCandlestickPlot_category_axis_line_color_description);
		...
		valAxisLabelColorD
				.setDescription(Messages.MCandlestickPlot_value_axis_label_color_description);
		...
		valAxisTickLabelColorD
				.setDescription(Messages.MCandlestickPlot_value_axis_tick_label_color_description);
		...
		valAxisLineColorD
				.setDescription(Messages.MCandlestickPlot_value_axis_line_color_description);
		...
		catAxisTickLabelMaskD
				.setDescription(Messages.MCandlestickPlot_category_axis_tick_label_mask_description);
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_FONT)) {
			jrElement.setTimeAxisLabelFont(MFontUtil.setMFont(value));
				...
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_FONT)) {
			jrElement.setTimeAxisTickLabelFont(MFontUtil.setMFont(value));
		} else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_FONT)) {
			jrElement.setValueAxisLabelFont(MFontUtil.setMFont(value));
		} else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT)) {
			jrElement.setValueAxisTickLabelFont(MFontUtil.setMFont(value));
		} else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setTimeAxisLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setTimeAxisTickLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR)
				&& value instanceof RGB)
			jrElement.setTimeAxisLineColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisTickLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisLineColor(Colors
					.getAWT4SWTRGBColor((RGB) value));

		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_VERTICAL_TICK_LABELS))
			jrElement.setTimeAxisVerticalTickLabels((Boolean) value);
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS))
			jrElement.setValueAxisVerticalTickLabels((Boolean) value);

		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_MASK))
			jrElement.setTimeAxisTickLabelMask((String) value);
		else if (id
				.equals(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK))
