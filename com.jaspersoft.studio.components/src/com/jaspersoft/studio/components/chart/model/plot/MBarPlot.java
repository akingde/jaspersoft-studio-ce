...
public class MBarPlot extends MChartPlot {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc,
		...
		catAxisLabelColorD
				.setDescription(Messages.MBarPlot_category_axis_label_color_description);
		...
		catAxisTickLabelColorD
				.setDescription(Messages.MBarPlot_category_axis_tick_label_color_description);
		desc.add(catAxisTickLabelColorD);

		FontPropertyDescriptor catAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_FONT,
		...
		catAxisLineColorD
				.setDescription(Messages.MBarPlot_category_axis_line_color_description);
		...
		valAxisLabelColorD
				.setDescription(Messages.MBarPlot_value_axis_label_color_description);
		...
		valAxisTickLabelColorD
				.setDescription(Messages.MBarPlot_value_axis_tick_label_color_description);
		desc.add(valAxisTickLabelColorD);

		FontPropertyDescriptor valAxisTickLabelFontD = new FontPropertyDescriptor(
				JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT,
		...
		valAxisLineColorD
				.setDescription(Messages.MBarPlot_value_axis_line_color_description);
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_FONT)) {
			jrElement.setCategoryAxisLabelFont(MFontUtil.setMFont(value));
				...
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_FONT)) {
			...
			jrElement.setValueAxisLabelFont(MFontUtil.setMFont(value));
				...
				.equals(JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT)) {
			jrElement.setValueAxisTickLabelFont(MFontUtil.setMFont(value));
		} else if (id
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setCategoryAxisLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setCategoryAxisTickLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_LINE_COLOR)
				&& value instanceof RGB)
			jrElement.setCategoryAxisLineColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id.equals(JRDesignBarPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id
				.equals(JRDesignBarPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisTickLabelColor(Colors
					.getAWT4SWTRGBColor((RGB) value));
		else if (id.equals(JRDesignBarPlot.PROPERTY_VALUE_AXIS_LINE_COLOR)
				&& value instanceof RGB)
			jrElement.setValueAxisLineColor(Colors
					.getAWT4SWTRGBColor((RGB) value));

		else if (id
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_VERTICAL_TICK_LABELS))
			jrElement.setCategoryAxisVerticalTickLabels((Boolean) value);
		else if (id
				.equals(JRDesignBarPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS))
			...
			jrElement.setShowLabels((Boolean) value);
				...
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK))
			...
			jrElement.setValueAxisTickLabelMask((String) value);
				...
				.equals(JRDesignBarPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_ROTATION))
