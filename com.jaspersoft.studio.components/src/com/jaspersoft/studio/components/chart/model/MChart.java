...
public class MChart extends MGraphicElementLineBox implements IContainer,
		IContainerEditPart, IPastable, IDatasetContainer {
	...
	public void createPropertyDescriptors(List<IPropertyDescriptor> desc,
		...
		SpinnerPropertyDescriptor bookmarkLevel = new SpinnerPropertyDescriptor(
				JRDesignChart.PROPERTY_BOOKMARK_LEVEL,
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(JRBaseChart.PROPERTY_TITLE_POSITION))
			return titlePositionD
					.getIntValue(jrElement.getTitlePositionValue());
	...
	public Object getPropertyActualValue(Object id) {
		...
		if (id.equals(JRBaseChart.PROPERTY_TITLE_POSITION)) {
			...
			return titlePositionD.getIntValue(position != null ? position
					: EdgeEnum.TOP);
		}
		if (id.equals(JRBaseChart.PROPERTY_LEGEND_POSITION)) {
			EdgeEnum position = jrElement.getLegendPositionValue();
			return legendPositionD.getIntValue(position != null ? position
					: EdgeEnum.BOTTOM);
		}
		if (id.equals(JRBaseChart.PROPERTY_TITLE_COLOR))
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals(JRDesignChart.PROPERTY_TITLE_FONT)) {
			...
			if (value instanceof AlfaRGB)
				jrElement.setTitleColor(Colors
			...
			if (value instanceof AlfaRGB)
				jrElement.setLegendColor(Colors
						.getAWT4SWTRGBColor((AlfaRGB) value));
			...
			jrElement.setAnchorNameExpression(ExprUtil.setValues(
					jrElement.getAnchorNameExpression(), value));
		else if (id.equals(JRDesignChart.PROPERTY_BOOKMARK_LEVEL))
			jrElement.setBookmarkLevel(value != null ? Integer.parseInt(value
					.toString()) : 0);
			...
			JRHyperlinkParameter[] oldParameters = jrElement
	...
	public List<MDatasetRun> getDatasetRunList() {
		...
		if (oldObject != null && oldObject.getDataset() != null) {
			...
			MDatasetRun mDatasetRun = new MDatasetRun(oldObject.getDataset()
					.getDatasetRun(), getJasperDesign());
	...
	public void trasnferProperties(JRElement target) {
		...
		if (jrSource != null) {
			...
			jrTarget.setSubtitleColor(getColorClone(jrSource
					.getOwnSubtitleColor()));
			jrTarget.setLegendColor(getColorClone(jrSource.getOwnLegendColor()));
			jrTarget.setLegendBackgroundColor(getColorClone(jrSource
					.getOwnLegendBackgroundColor()));
		}
	}
}
