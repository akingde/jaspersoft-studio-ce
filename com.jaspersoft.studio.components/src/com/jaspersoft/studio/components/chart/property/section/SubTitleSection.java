...
public class SubTitleSection extends AbstractRealValueSection {
	...
	public void createControls(Composite parent,
		...
		Composite group = getWidgetFactory().createSection(parent, Messages.SubTitleSection_Subtitle_Label,
				true, 2);

		getWidgetFactory().createCLabel(group, Messages.SubTitleSection_Expression_Label);
		createWidget4Property(group,
				JRDesignChart.PROPERTY_SUBTITLE_EXPRESSION, false);

		getWidgetFactory().createCLabel(group, Messages.SubTitleSection_Color_Label);
