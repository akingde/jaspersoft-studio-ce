...
public class Bar3dPlot extends APlot {
	...
	public Bar3dPlot(Composite parent, AbstractSection section) {
		super(parent, section);
	}

	private Btn3Boolean showLabels;
	private BtnNumber xoffset;
	private BtnNumber yoffset;
	...
	protected void createComponent(Composite parent, AbstractSection section) {
		...
		section.getWidgetFactory().createCLabel(composite, "x", SWT.RIGHT);

		xoffset = new BtnNumber(
				composite,
				section,
				JRDesignBar3DPlot.PROPERTY_X_OFFSET,
				com.jaspersoft.studio.components.chart.messages.Messages.MBar3DPlot_x_offset_description);

		section.getWidgetFactory().createCLabel(composite, "y", SWT.RIGHT);

		yoffset = new BtnNumber(
				composite,
				section,
				JRDesignBar3DPlot.PROPERTY_Y_OFFSET,
				com.jaspersoft.studio.components.chart.messages.Messages.MBar3DPlot_y_offset);
	...
	private void createCategory(Composite parent, AbstractSection section) {
		...
		caxTickLblColor = new BtnColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MBar3DPlot_category_axis_tick_label_color_description);
		...
		caxTickLblMask = new BtnText(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MBar3DPlot_category_axis_tick_label_mask_description);
	...
	private void createValue(Composite parent, AbstractSection section) {
		...
		vaxTickLblColor = new BtnColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MBar3DPlot_value_axis_tick_label_color_description);
	...
	public void setData(MChartPlot mplot) {
		MChartItemLabel cil = (MChartItemLabel) mplot
				.getPropertyValue(JRDesignBar3DPlot.PROPERTY_ITEM_LABEL);
		chItemLabel.setData(cil);

		showLabels.setData((Boolean) mplot
				.getPropertyValue(JRDesignBar3DPlot.PROPERTY_SHOW_LABELS));

		xoffset.setData((Double) mplot
				.getPropertyValue(JRDesignBar3DPlot.PROPERTY_X_OFFSET));

		yoffset.setData((Double) mplot
				.getPropertyValue(JRDesignBar3DPlot.PROPERTY_Y_OFFSET));

		caxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_LINE_COLOR));
		caxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_LABEL_COLOR));
		caxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_LABEL_FONT));
		caxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_COLOR));
		caxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_FONT));
		caxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_VERTICAL_TICK_LABELS));
		caxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_MASK));
		caxTickLblRotation
				.setData((Double) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_TICK_LABEL_ROTATION));
		caxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_CATEGORY_AXIS_LABEL_EXPRESSION));

		caxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION));
		caxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION));
		// ---------------------------------
		vaxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_LINE_COLOR));
		vaxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR));
		vaxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_LABEL_FONT));
		vaxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR));
		vaxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT));
		vaxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS));
		vaxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK));
		vaxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION));

		vaxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_RANGE_AXIS_MINVALUE_EXPRESSION));
		vaxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignBar3DPlot.PROPERTY_RANGE_AXIS_MAXVALUE_EXPRESSION));
	}
}
