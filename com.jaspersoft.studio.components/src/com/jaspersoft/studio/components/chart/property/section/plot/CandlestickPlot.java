...
public class CandlestickPlot extends APlot {
	...
	public CandlestickPlot(Composite parent, AbstractSection section) {
		super(parent, section);
	}

	private Btn3Boolean showVolume;
	...
	protected void createComponent(Composite parent, AbstractSection section) {
		...
		CLabel lbl = section
				...
				.createCLabel(
						composite,
						com.jaspersoft.studio.components.chart.messages.Messages.MCandlestickPlot_show_volume,
						SWT.RIGHT);
		RowData rd = new RowData();
		rd.width = 101;
		lbl.setLayoutData(rd);

		showVolume = new Btn3Boolean(
				composite,
				section,
				JRDesignCandlestickPlot.PROPERTY_SHOW_VOLUME,
				com.jaspersoft.studio.components.chart.messages.Messages.MCandlestickPlot_show_volume_description);
	...
	private void createCategory(Composite parent, AbstractSection section) {
		...
		caxTickLblColor = new BtnColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MCandlestickPlot_category_axis_tick_label_color_description);
	...
	private void createValue(Composite parent, AbstractSection section) {
		...
		vaxTickLblColor = new BtnColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MCandlestickPlot_value_axis_tick_label_color_description);
	...
	public void setData(MChartPlot mplot) {
		showVolume
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_SHOW_VOLUME));
		caxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LINE_COLOR));
		caxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_COLOR));
		caxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_FONT));
		caxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_COLOR));
		caxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_FONT));
		caxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_VERTICAL_TICK_LABELS));
		caxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_TICK_LABEL_MASK));
		caxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_TIME_AXIS_LABEL_EXPRESSION));

		caxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION));
		caxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION));
		// ---------------------------------
		vaxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LINE_COLOR));
		vaxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_COLOR));
		vaxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_FONT));
		vaxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_COLOR));
		vaxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_FONT));
		vaxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_VERTICAL_TICK_LABELS));
		vaxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_TICK_LABEL_MASK));
		vaxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_VALUE_AXIS_LABEL_EXPRESSION));

		vaxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_RANGE_AXIS_MINVALUE_EXPRESSION));
		vaxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignCandlestickPlot.PROPERTY_RANGE_AXIS_MAXVALUE_EXPRESSION));
	}
}
