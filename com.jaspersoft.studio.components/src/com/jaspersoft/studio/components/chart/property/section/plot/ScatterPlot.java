...
public class ScatterPlot extends APlot {
	...
	public ScatterPlot(Composite parent, AbstractSection section) {
	...
	private void createCategory(Composite parent, AbstractSection section) {
		...
		caxTickLblColor = new SPColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MScatterPlot_category_axis_tick_label_color_description);
	...
	private void createValue(Composite parent, AbstractSection section) {
		...
		vaxTickLblColor = new SPColor(
				...
				com.jaspersoft.studio.components.chart.messages.Messages.MScatterPlot_value_axis_tick_label_color_description);
	...
	public void setData(MChartPlot mplot) {
		...
		showLines.setData((Boolean) mplot
				.getPropertyValue(JRDesignScatterPlot.PROPERTY_SHOW_LINES));

		showShapes.setData((Boolean) mplot
				.getPropertyValue(JRDesignScatterPlot.PROPERTY_SHOW_SHAPES));

		caxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_LINE_COLOR));
		caxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_COLOR));
		caxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_FONT));
		caxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_COLOR));
		caxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_FONT));
		caxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_VERTICAL_TICK_LABELS));
		caxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_TICK_LABEL_MASK));

		caxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_X_AXIS_LABEL_EXPRESSION));

		caxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION));
		caxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION));
		// ---------------------------------
		vaxLineColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_LINE_COLOR));
		vaxLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_COLOR));
		vaxLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_FONT));
		vaxTickLblColor
				.setData((RGB) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_COLOR));
		vaxTickLblFont
				.setData(
						mplot,
						(MFont) mplot
								.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_FONT));
		vaxTickLblShow
				.setData((Boolean) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_VERTICAL_TICK_LABELS));
		vaxTickLblMask
				.setData((String) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_TICK_LABEL_MASK));
		vaxLblExpr
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_Y_AXIS_LABEL_EXPRESSION));

		vaxRangeMin
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_RANGE_AXIS_MINVALUE_EXPRESSION));
		vaxRangeMax
				.setData((JRDesignExpression) mplot
						.getPropertyValue(JRDesignScatterPlot.PROPERTY_RANGE_AXIS_MAXVALUE_EXPRESSION));
	}
}
