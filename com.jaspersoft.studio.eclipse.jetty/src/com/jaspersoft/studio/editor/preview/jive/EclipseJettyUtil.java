...
/**
 * Utility class to interact with Jetty 7.x/8.x (org.eclipse.jetty.xxx plug-ins) 
 * server when using Jive.
 */
public class EclipseJettyUtil implements JiveJettyUtilitiesProvider {
	
	private static EclipseJettyUtil instance;
	...
	private EclipseJettyUtil(){
	}
	
	public static synchronized EclipseJettyUtil getInstance(){
		if(instance==null){
			instance=new EclipseJettyUtil();
		}
		return instance;
	}
