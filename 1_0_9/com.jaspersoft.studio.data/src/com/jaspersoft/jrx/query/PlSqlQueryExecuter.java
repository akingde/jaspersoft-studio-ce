 ...
 * are only going to run inline SQL you should use the normal JRJdbcQueryExecuter
 * instead.
 * <p/>
 ...
 * by Teodor Danciu (teodord@users.sourceforge.net) in JRJdbcQueryExecuter.
 */
public class PlSqlQueryExecuter extends JRAbstractQueryExecuter
{
    ...
    public PlSqlQueryExecuter(JRDataset dataset, Map<String, ? extends JRValueParameter> parameters)
    {
    ...
    /**
     * Check to see if the current query is actuall a call to an oracle
     * stored procedure.
     *
     ...
     */
    private boolean isOracleStoredProcedure(String queryString) throws SQLException {
