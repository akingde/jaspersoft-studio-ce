...
public class ResourcePublisher extends IResourcesInput{
	...
	public String getPluginName() {
		return "com.jaspersoft.studio.kpi";
	}
	...
	protected List<AbstractResourceDefinition> initializeProperties(){
		...
		result.add(new PackageResourceDefinition("en_EN", 
																						 "com.jaspersoft.studio.kpi.messages", 
																						 "messages.properties", 
																						 "In this file there are the standard strings used by the kpi plugin",
																						 getClassLoader(),
																						 "com/jaspersoft/studio/kpi/messages/messages.properties", this));
		
		result.add(new PackageResourceDefinition("en_EN", 
																						 "com.jaspersoft.studio.kpi.messages", 
																						 "messagesbykeys.properties", 
																						 "In this file there are the standard strings used by the kpi plugin, used dinamically",
																						 getClassLoader(),
																						 "com/jaspersoft/studio/kpi/messages/messagesbykeys.properties", this));
