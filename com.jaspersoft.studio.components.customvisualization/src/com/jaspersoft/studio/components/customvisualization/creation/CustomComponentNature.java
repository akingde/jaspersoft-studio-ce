...
/**
 * Define a specific nature for a custom visualization component project
 * 
 * @author Orlandin Marco
 *
 */
public class CustomComponentNature implements IProjectNature {

	/**
	 * ID of this project nature
	 */
	public static final String NATURE_ID = "com.jaspersoft.studio.components.customvisualization.customcomponentnature"; //$NON-NLS-1$
	...
	public static void createJRProject(IProgressMonitor monitor, IProject prj) throws CoreException {
		addNature(prj, CustomComponentNature.NATURE_ID, monitor);
	}
	 ...
	 * @return true if the project exist, is open and accessible, false otherwise
	 */
