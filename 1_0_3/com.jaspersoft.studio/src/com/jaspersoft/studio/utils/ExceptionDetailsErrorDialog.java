...
public class ExceptionDetailsErrorDialog extends IconAndMessageDialog {
	 ...
	 * the error object being displayed contains child items <it>and </it> you need to specify a mask which will be used
	 * to filter the displaying of these children.
	 * </p>
	 * 
	 * @param parentShell
	 ...
	 * @param message
	 *          the message to show in this dialog, or <code>null</code> to indicate that the error's message should be
	...
	/*
	 * (non-Javadoc) Method declared on Dialog. Handles the pressing of the Ok or Details button in this dialog. If the Ok
	 * button was pressed then close this dialog. If the Details button was pressed then toggle the displaying of the
	 * error details area. Note that the Details button will only be visible if the error being displayed specifies child
	 * details.
	 */
	@Override
	 ...
	 * child items <it>and </it> you wish to specify a mask which will be used to filter the displaying of these children.
	...
	/**
	 * Show the details portion of the dialog if it is not already visible. This method will only work when it is invoked
	 * after the control of the dialog has been set. In other words, after the <code>createContents</code> method has been
	 * invoked and has returned the control for the content area of the dialog. Invoking the method before the content
	 * area has been set or after the dialog has been disposed will have no effect.
	 * 
	 * @since 3.1
	 */
